  ...
  "paying-for-care": [
    {
      ...
      body: (
        <>
          <p>
            In Canada, medical care is largely covered, but long-term help with
            daily living is a patchwork of public programs, tax measures, and
            private money, and the private share grows as needs grow. The
            families who manage best are not the richest ones. They are the ones
            who mapped the resources early and used every layer in order.
          </p>
          <p>
            Almost every family pays in the wrong order. They reach for private
            savings and private services first, because those are the doors that
            advertise. The layers that do not advertise, public programs, tax
            credits that refund money already being spent, benefits your parent
            is entitled to but never claimed, get left on the table. Here are
            the layers, in the order to use them.
          </p>
        </>
      ),
    },
      ...
      body: (
        <>
          <p>
            ...
            and community services are the base layer, and they are chronically
            underused because nobody advertises them. One assessment call opens
            the file. In Ontario, that call is Ontario Health atHome at 310-2222
            (no area code needed), and 211 covers everything else, 24/7, in 150+
            languages. Every province has an equivalent front door; call 211
            anywhere in Canada and ask for "home care intake for seniors."
          </p>
          <p>
      ...
      body: (
        <>
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              <strong>The disability tax credit:</strong> a gateway credit that
              unlocks others, can transfer to a supporting child, and can be
              claimed retroactively up to ten years. Dementia frequently
            ...
            <li>
              <strong>The Home Accessibility Tax Credit:</strong> 15 percent of
              up to $20,000 a year in safety renovations.
            </li>
            <li>
          ...
          <p>
            The rule of the tax layer: keep every receipt, file every year even
            with no income, and spend one hour annually with someone who knows
            seniors' credits. That hour reliably pays for itself several times
            over.
          </p>
        </>
      ),
      ...
      body: (
        <>
          <p>
            ...
            provincial top-ups like Ontario's GAINS, veterans' programs
            (housekeeping and grounds maintenance funding through the Veterans
            Independence Program surprises many families; ask whether even short
            service counts), and drug cost programs. Every one of these flows
            from a filed tax return, which is why the return is the master key:
            a parent with no income owing still needs to file, every year, on
            time. Free tax clinics exist for exactly this; ask 211.
          </p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          <p>
            <strong>Insurance fourth:</strong> some parents hold long-term care
            insurance, critical illness coverage, or workplace retiree benefits
            nobody has looked at in years. Find the policies before assuming
            there are none.
          </p>
          <p>
            <strong>Family money and family labour fifth, and out loud.</strong>{" "}
            Decide together whose money pays (the parent's own resources usually
            should come first, both practically and legally), track what is
            spent, and put any sibling arrangements in writing. Money handled in
            silence becomes resentment; money handled in a shared spreadsheet
            stays money.
          </p>
        </>
      ),
      ...
      body: (
        <>
          ...
          <ol className="list-decimal space-y-2 pl-6">
            ...
            <li>
              <strong>Rent out part of it.</strong> Income without leaving, but
              it makes your parent a landlord, with everything that means.
            </li>
            <li>
          ...
          <p>
            ...
            understanding your family's whole picture is selling, not advising.
            Take the time to compare all four, in writing, with the ongoing
            costs and the ten-year picture included, and treat any adviser's
            willingness to show you the option that pays them nothing as the
            test of the advice.
          </p>
        </>
      ),
      ...
      body: (
        <>
          <p>
            ...
            simple: more than one set of eyes on the accounts (many banks offer
            view-only access or duplicate statements for a trusted contact),
            powers of attorney chosen with care, and an agreed family rule that
            no financial decision happens under pressure or in secret. Talk
            about scams openly and without condescension. Shame is the scammer's
            best friend; a family that jokes about scam calls at dinner is a
            family that reports them.
          </p>
          <p className="italic">
      ...
      body: (
        <>
          <p>
            ...
            documents are universal, and all of them share one unforgiving rule:
            they can only be created while the person still has the mental
            capacity to understand them. Early is everything. If dementia is
            anywhere in the picture, do these the month you start wondering, not
            the month after diagnosis.
          </p>
        </>
      ),
    },
        ...
        <>
          <ol className="list-decimal space-y-4 pl-6">
            ...
            <li>
              ...
              take over, a process that is slow, public, and expensive, arriving
              precisely at the worst moment.
            </li>
            <li>
              <strong>
                A power of attorney or directive for personal and health care.
              </strong>{" "}
              Names who decides about care, housing, and treatment when your
              parent cannot, and can carry written wishes.
            </li>
            <li>
              ...
              document matters; the conversation around it matters more, because
              the named decision-maker will one day need to hear your parent's
              voice in their memory.
            </li>
            <li>
      ...
      body: (
        <>
          <p>
            ...
            (health and living decisions), governed by the Substitute Decisions
            Act. The Ontario government publishes a free POA kit (ontario.ca,
            search "power of attorney kit"), though for anything beyond a simple
          ...
          <p>
            ...
            prevents both panic and family warfare, but a named attorney of your
            parent's own choosing beats the default list every time.
          </p>
          <p>
        ...
        <>
          <ol className="list-decimal space-y-2 pl-6">
            <li>
              ...
              families, business ownership, property in more than one place, or
              family conflict are worth a real lawyer, and one focused hour is
              cheaper than the mess.
            </li>
            <li>
              Tell the named people they are named, and tell them where the
              documents are. A power of attorney nobody can find does not exist.
            </li>
            <li>
              Revisit after any major life event: a death, a move, a diagnosis,
              a falling-out.
            </li>
          </ol>
        </>
      ...
      body: (
        <>
          <p>
            ...
            hierarchies for medical consent, and an elder law lawyer or hospital
            social worker can tell you exactly where you stand. Later than ideal
            is still workable. It is just slower, and it is why this page nags
            everyone else to go early.
          </p>
          <p className="italic">
